"""
Django settings for yoga_vibe project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'star_rating': 'products.templatetags.star_rating',  # Register your custom tag here
            },
        },
    },
]
...
WSGI_APPLICATION = 'yoga_vibe.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'yoga-vibe-pp5'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'yogavibe@example.com'
else:
